...
# 체커보드의 차원 정의
CHECKERBOARD = (6,5) # 체커보드 행과 열당 내부 코너 수
...
images = glob.glob('C:/data//DCSP/PIXPRO SP360/data_1/*.jpg')
...
# 이미지 왜곡 보정
#img = cv2.imread("C:/data/DCSP/PIXPRO SP360/data_1/109_0002.MP4_20220718_164946.175.jpg")
#h,  w = img.shape[:2]
